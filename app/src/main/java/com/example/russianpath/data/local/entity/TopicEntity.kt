// app/src/main/java/com/example/russianpath/data/local/entity/TopicEntity.kt
...
@Entity(
    tableName = "topics",
    foreignKeys = [
        ForeignKey(entity = SectionEntity::class, parentColumns = ["id"], childColumns = ["section_id"], onDelete = ForeignKey.CASCADE, onUpdate = ForeignKey.CASCADE),
    ...
    indices = [
        Index(value = ["section_id", "sort_order"], name = "idx_topics_section_sort"),
        Index(value = ["grade_id", "sort_order"], name = "idx_topics_grade_sort"),
        Index(value = ["external_id"], name = "idx_topics_external_id", unique = true),
        Index(value = ["section_id"], name = "idx_topics_section_id"),
        Index(value = ["grade_id"], name = "idx_topics_grade_id"),
        Index(value = ["is_active", "is_unlocked"], name = "idx_topics_active_unlocked")
    ]
)
data class TopicEntity(
    ...
    @ColumnInfo(name = "grade_id", defaultValue = "") val gradeId: String = "",
    ...
    @ColumnInfo(name = "is_unlocked", defaultValue = "0") val isUnlocked: Boolean = false,
    @ColumnInfo(name = "is_active", defaultValue = "1") val isActive: Boolean = true,
    @ColumnInfo(name = "difficulty_level", defaultValue = "1") val difficultyLevel: Int = 1,
    @ColumnInfo(name = "estimated_minutes", defaultValue = "15") val estimatedMinutes: Int = 15,
    @ColumnInfo(name = "prerequisite_topic_ids_json", defaultValue = "[]") val prerequisiteTopicIdsJson: String = "[]",
