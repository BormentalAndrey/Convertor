...
@Entity(
    tableName = "lessons",
    foreignKeys = [
        ForeignKey(entity = TopicEntity::class, parentColumns = ["id"], childColumns = ["topic_id"], onDelete = ForeignKey.CASCADE, onUpdate = ForeignKey.CASCADE),
        ForeignKey(entity = LearningObjectiveEntity::class, parentColumns = ["id"], childColumns = ["primary_objective_id"], onDelete = ForeignKey.SET_NULL, onUpdate = ForeignKey.CASCADE)
    ],
    indices = [
...
data class LessonEntity(
    ...
    @ColumnInfo(name = "primary_objective_id", defaultValue = "") val primaryObjectiveId: String = "",
    @ColumnInfo(name = "lesson_type", defaultValue = "practice") val lessonType: String = "practice",
    ...
    @ColumnInfo(name = "theory_json", defaultValue = "{}") val theoryJson: String = "{}",
    @ColumnInfo(name = "instruction_text", defaultValue = "") val instructionText: String = "",
    @ColumnInfo(name = "questions_count", defaultValue = "0") val questionsCount: Int = 0,
    @ColumnInfo(name = "time_limit_seconds", defaultValue = "0") val timeLimitSeconds: Int = 0,
    @ColumnInfo(name = "passing_score_percent", defaultValue = "70") val passingScorePercent: Int = 70,
    @ColumnInfo(name = "max_stars", defaultValue = "3") val maxStars: Int = 3,
    @ColumnInfo(name = "xp_base_reward", defaultValue = "50") val xpBaseReward: Int = 50,
    @ColumnInfo(name = "xp_perfect_bonus", defaultValue = "25") val xpPerfectBonus: Int = 25,
    @ColumnInfo(name = "gems_reward", defaultValue = "5") val gemsReward: Int = 5,
    @ColumnInfo(name = "is_bonus", defaultValue = "0") val isBonus: Boolean = false,
    @ColumnInfo(name = "is_diagnostic", defaultValue = "0") val isDiagnostic: Boolean = false,
